...
--
-- Host: 127.0.0.1
-- Generation Time: 05 Okt 2016 pada 17.54
-- Versi Server: 5.6.21
-- PHP Version: 5.5.19
...
INSERT INTO `tbl_pendaftaran` (`id_pendaftar`, `nisn`, `nama`, `Kelamin`, `agama`, `tempat_tanggal_lahir`, `asal_sekolah`, `alamat`, `no_telepon`, `nama_ayah`, `pekerjaan_ayah`, `nama_ibu`, `pekerjaan_ibu`, `agama_orang_tua`, `alamat_orang_tua`, `no_hp_orang_tua`) VALUES
(4, '012345', 'boy men', 'Laki-laki', 'islam', 'Banyuwangi, 20 April 1996', 'MTsn Banyuwangi 2', 'Jl Banyu Biru 02 Banyuwangi', 2147483647, 'Pay Jo', 'Swasta', 'Sawi Tri', 'Swasta', 'Islam', 'Jl Banyu Biru 02 Banyuwangi', 2147483647);
...
--
ALTER TABLE `tbl_nilai`
MODIFY `id_pendaftar` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `tbl_pendaftaran`
--
ALTER TABLE `tbl_pendaftaran`
MODIFY `id_pendaftar` int(255) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
